...
* 2:00-4:50 Optional themes:
  * VM machines, containers: why?
    - Virtual machine software for your own computer: [VirtualBox](https://www.virtualbox.org/)
    - Virtual machines at Cornell: [RedCloud](https://www.cac.cornell.edu/services/cloudservices.aspx) but may also be available through CISER.
    - Container software: [Docker](https://www.docker.com/products/docker-desktop)
  * Automating processing in the cloud (Docker, etc.)
    - Example of an automated data cleaning step using Docker and Github actions: [Covid-19 expectations data](https://github.com/labordynamicsinstitute/covid19-expectations-data/blob/master/.github/workflows/main.yml)
